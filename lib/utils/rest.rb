...
module StarkCore
  module Utils
    module Rest
      ...
      def self.get_id(resource_name:, resource_maker:, sdk_version:, host:, api_version:, user:, language:, timeout:)
        json = StarkCore::Utils::Request.fetch(
          host: host,
          sdk_version: sdk_version,
          user: user,
      ...
      def self.post(resource_name:, resource_maker:, sdk_version:, host:, api_version:, user:, language:, timeout:, entities:)
        jsons = []
        entities.each do |entity|
