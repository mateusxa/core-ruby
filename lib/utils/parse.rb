  ...
  module Utils
    module Parse
      def self.parse_and_verify(content:, signature:, sdk_version:, api_version:, 
                                host:, resource:, user:, language:, timeout:, key: nil)
      ...
      def self.verify(content:, signature:, sdk_version:, api_version:, host:, 
                      resource:, user:, language:, timeout:, key: nil)
        begin
      ...
      def self.get_public_key_pem(sdk_version:, host:, api_version:, path:, user:, language:, timeout:, refresh: false, **query)
